...
// [CUSTOM] Interrupt vector table dat tai 0x80001000 (trong bootloader region 32KB).
// ADS default: 0x801F4000 (cuoi Flash). Bootloader muon tat ca vectors nam trong 32KB cua minh.
#define LCF_INTVEC0_START	0x80001000  //0x801F4000
// [CUSTOM] Trap table CPU0 dat tai 0x80000100 (trong bootloader region, ngay sau BMHD).
// ADS default: cuoi Flash. Khi App chay, App co trap table rieng tai 0x80008100.
...
// [CUSTOM] Bootloader entry point = 0x80000020 (offset 0x20 tu dau PFlash).
// BROM (Boot ROM) sau khi verify BMHD se nhay vao dia chi nay.
// App dung 0x80008020 (dich 32KB de nhuong cho bootloader).
